...
public enum ExceptionPayloadFactory {
    ...
    QUIZ_INSTANCE_CLOSED(12, HttpStatus.FORBIDDEN, "quiz.instance.closed"),
    QUIZ_INSTANCE_DETAILS_NOT_FOUND(13, HttpStatus.NOT_FOUND, "quiz.instance.details.not.found"),
    REGISTRATION_CODE_NOT_FOUND(14, HttpStatus.NOT_FOUND, "registration.code.not.found"),
    QUESTION_ALREADY_ANSWERED(15, HttpStatus.BAD_REQUEST, "question.already.answered"),
    QUIZ_INSTRUCTIONS_NOT_FOUND(16, HttpStatus.NOT_FOUND, "quiz.instructions.not.found"),
    QUESTIONS_NOT_FOUND(17, HttpStatus.NOT_FOUND, "questions.not.found"),
    INVALID_RATING_PAYLOAD(18, HttpStatus.BAD_REQUEST, "invalid.rating.payload"),
    QUIZ_INSTANCE_FINISHED(19, HttpStatus.FORBIDDEN, "quiz.instance.finished"),
    GOODIES_OUT_OF_STOCK(20, HttpStatus.BAD_REQUEST, "goodies.out.of.stock"),
    QUIZ_EVENT_PARTICIPANT_NOT_FOUND(21, HttpStatus.NOT_FOUND, "quiz.participant.not.found"),
    MISSING_REQUEST_BODY_ERROR_CODE(22, HttpStatus.BAD_REQUEST, "request.missing.body"),
    GOODY_NOT_FOUND(23, HttpStatus.NOT_FOUND, "goody.not.found"),
    PARTICIPANT_IS_NOT_ELIGIBLE_FOR_GOODY(24, HttpStatus.BAD_REQUEST, "participant.not.eligible.for.goody"),
